...
<template>
    <section class="text-gray-600 body-font relative">
        <div
            class="container px-5 py-24 mx-auto flex md:flex-nowrap flex-wrap animate__backInLeft"
        >
            <div
                class="lg:w-2/3 md:w-1/2 bg-gray-100 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-center justify-start flex-wrap"
            >
                <img
                    class="rounded-full max-w-1/3 p-2 m-auto"
                    :src="'storage/img/IMG-d622f1c9287bcb3ef677af2684b8434f-V.jpg'"
                />
                <p class="lg:w-4/5 mx-auto leading-relaxed text-base">
                    I’m always happy to hear from fellow art enthusiasts and
                    collaborators. I look forward to connecting with you!
                    <br /><br />

                    Thank you for your interest in my artwork! If you have any
                    questions about my paintings, would like to discuss a
                    commission, or just want to learn more about my process,
                    please get in touch. I’m always happy to hear from fellow
                    art enthusiasts and collaborators.
                </p>
                ...
                >
                    <a class="text-indigo-500">info@galawij.com</a>
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a
                            href="https://www.facebook.com/Galawijgallery"
                            target="_blank"
                        ...
                        <a
                            href="https://www.instagram.com/galawij_gallery/"
                            target="_blank"
                            class="text-gray-500 hover:text-gray-200 dark:hover:text-white"
                        >
                            <svg
                           ...
                           2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0
                           011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06
                           1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049
                           1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153
                           1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643
                           ...
                           0 00-.748-1.15 3.098 3.098 0 00-1.15-.748c-.353-.137-.882-.3-1.857-.344-1.023-.047-1.351-.058-3.807-.058zM12 6.865a5.135
            ...
            >
                ...
                <form @submit.prevent>
                    ...
                    <button
                        class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg cursor-pointer"
                        name="submit"
                        type="submit"
                        @click="submit"
                    >
